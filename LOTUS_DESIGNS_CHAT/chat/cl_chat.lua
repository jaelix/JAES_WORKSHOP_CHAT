...
AddEventHandler('chat:clear', function(name)
  ...
  TriggerServerEvent('fivecode_rpchat:notify', GetPlayerServerId(PlayerId()), 'info', 'Chat has been cleared!', false)
end)
...
SetResourceKvp('hideState', tostring(CHAT_HIDE_STATES.SHOW_WHEN_ACTIVE))
